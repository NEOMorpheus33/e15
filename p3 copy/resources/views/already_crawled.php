...
function get_details($url) {   
	...
	$options = array('http'=>array('method'=>"GET", 'headers'=>"User-Agent: JoeBot/0.1\n"));
	...
	<ol>return <li>'{"Title": "'.str_replace("\n", "", $title).'",</li> <li>"Description": "'.str_replace("\n","",</li> $description).'", "Keywords": "'.str_replace("\n", "",</li> $keywords).'", "URL": "'.</li>$url.'"},'; </li></ol>
